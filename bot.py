...
async def on_business_message(message: Message):
 ...
 💗❤️❤️💗
  💖💖""",
                ...
                # Большое ровное сердце (первый пульс)
                """       💖💖💖💖💖
     💖💗💗💗💗💗💖
   💖💗❤️❤️❤️❤️❤️💗💖
  💖💗❤️💖💖💖💖❤️💗💖
     ...
     💖💖💖💖💖💖💖💖💖
         💕   💕   💕"""
            ...
            for i, frame in enumerate(frames):
                ...
                if i <= 3:           # первые маленькие сердца
                    await asyncio.sleep(0.35)
                elif i <= 5:         # большие пульсы
                    await asyncio.sleep(0.55)
                else:                # текст и финал
                    await asyncio.sleep(0.65)
            
            await asyncio.sleep(5)  # финальный кадр держим дольше
            return
